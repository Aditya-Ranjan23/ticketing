    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['session_key', '-created_at'], name='analytics_u_session_d46ec3_idx'), models.Index(fields=['user', '-created_at'], name='analytics_u_user_id_e2feae_idx'), models.Index(fields=['action', '-created_at'], name='analytics_u_action_a18517_idx')],
            },
        ),
    ]
